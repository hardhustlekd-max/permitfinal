      ...
      <div className="no-print bg-surface-container/90 border-b border-outline-variant/80 px-3.5 py-2.5 flex flex-wrap items-center justify-between gap-2 shadow-xs text-xs shrink-0">
        ...
        <div className="flex items-center gap-1.5 ml-auto">
          ...
          <button
            ...
            disabled={scale <= 0.05}
            className="w-8 h-8 flex items-center justify-center bg-surface border border-outline-variant rounded-lg font-bold text-on-surface hover:bg-surface-container-high disabled:opacity-30 transition-all cursor-pointer"
          ...
          <button
            ...
            className="px-2.5 h-8 bg-surface border border-outline-variant rounded-lg font-bold text-xs text-secondary hover:text-on-surface hover:bg-surface-container-high transition-all cursor-pointer"
          ...
          {onPrint && (
            <button
              type="button"
              onClick={onPrint}
              className="w-8 h-8 flex items-center justify-center bg-primary hover:bg-primary-hover text-white rounded-lg font-bold transition-all cursor-pointer shadow-xs ml-0.5"
          ...
          {onClose && (
            <button
              type="button"
              onClick={onClose}
              className="w-8 h-8 flex items-center justify-center bg-surface-container-high border border-outline-variant rounded-lg text-secondary hover:text-on-surface transition-colors cursor-pointer ml-1"
              title="Close"
            >
