...
import { subscribeSettings, saveSettingsToDb, resetAllSystemData } from '../services/dbService';
...
export const SettingsPage: React.FC<SettingsPageProps> = ({
  ...
  // State for settings initialized from LocalStorage and updated via Firestore
