...
export const MunicipalDashboardOverview: React.FC<MunicipalDashboardOverviewProps> = ({
  ...
  return (
    <div className="space-y-4">
      ...
      {userRole === 'officer' && (
        <div className="bg-surface-container-lowest border border-outline-variant/60 rounded-xl p-3 shadow-xs space-y-3">
          ...
          <div className="p-2.5 bg-surface-container-low/50 border border-outline-variant rounded-lg space-y-2">
            ...
            <div className="relative">
              <div className="absolute inset-y-0 left-2.5 flex items-center justify-center pointer-events-none text-secondary">
              ...
              <input
                ...
                className="w-full bg-surface-container-lowest border border-outline-variant/60 rounded-lg pl-9 pr-8 py-2 text-xs font-medium text-on-surface focus:outline-none focus:ring-1 focus:ring-primary"
              />
              {searchPlate && (
                <button
                  type="button"
                  onClick={() => setSearchPlate('')}
                  className="absolute inset-y-0 right-2.5 flex items-center justify-center text-secondary hover:text-on-surface cursor-pointer"
                >
            ...
            {searchPlate.trim() && (
              <div className="pt-2">
                {livePlateSearchMatch ? (
                  <div className="p-3 bg-surface-container-lowest border border-outline-variant/60 rounded-xl flex flex-col sm:flex-row sm:items-center justify-between gap-3">
