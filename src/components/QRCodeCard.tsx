...
export const QRCodeCard: React.FC<QRCodeCardProps> = ({ registration, lang }) => {
  ...
  const numericDigits = (regId.replace(/\D/g, '') + '98414521').slice(0, 8);
  ...
  return (
    <div className="w-full font-sans overflow-x-auto py-2 scrollbar-thin">
      <div className="flex flex-col items-center gap-4 min-w-max mx-auto px-2">
        ...
        <div className="no-print flex items-center justify-end w-[580px]">
          <button
            type="button"
        ...
        {/* Exact Replica of Movement Permit ID Card - Width ~ 580px */}
        <div className="printable-id-card w-[580px] bg-[#e4f2f7] rounded-xl shadow-2xl border border-sky-200 overflow-hidden text-slate-800 relative shrink-0 select-none font-sans">
          ...
          <div className="relative z-10 p-4 pb-0 flex flex-col justify-between h-full">
            ...
            <div className="grid grid-cols-2 gap-x-6 gap-y-1.5 text-[12px]">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-baseline justify-between gap-1">
                  ...
                  <span className="font-mono font-bold text-[12px] text-slate-950 truncate max-w-[160px]">
                    {chassis}
                  </span>
                </div>
                ...
                <div className="flex items-baseline justify-between gap-1">
                  ...
                  <span className="font-bold text-xs text-slate-950 truncate max-w-[160px]">
                    {name}
                  </span>
                </div>
                ...
                <div className="flex items-baseline justify-between gap-1">
                  ...
                  <span className="font-bold text-xs text-slate-950 font-mono">
                    {issueDate}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  {portraitPhoto && (
                    <div className="w-10 h-12 rounded-md overflow-hidden border border-sky-300 shadow-xs shrink-0 bg-slate-200" title="User Portrait">
              ...
              <div className="space-y-1.5">
                ...
                <div className="flex items-baseline justify-between gap-1">
                  ...
                  <span className="font-bold text-xs text-slate-950 uppercase">
                    {motorModel}
                  </span>
                </div>
                ...
                <div className="flex items-baseline justify-between gap-1">
                  ...
                  <span className="font-mono font-bold text-[12px] text-slate-950 truncate max-w-[150px]">
                    {engineNo}
                  </span>
                </div>
                ...
                <div className="flex items-center justify-between gap-1 pt-0.5">
                  ...
                  <div className="bg-[#ea0000] text-white px-2.5 py-0.5 rounded-md font-black text-xs tracking-wider shadow-xs font-mono">
                    {expiryDate}
                  </div>
                </div>
                ...
                <div className="flex justify-end pt-1">
                  <div className="bg-white p-1 rounded-lg border border-slate-300 shadow-xs">
