        ...
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-3 gap-1.5 p-1 bg-surface-container rounded-xl border border-outline-variant">
            ...
            >
              ...
              <span className="text-[10px] text-on-surface-variant font-normal">CLERK-001</span>
            </button>
            ...
            >
              ...
              <span className="text-[10px] text-on-surface-variant font-normal">ADMIN-PRO-1</span>
            </button>
            ...
            >
              ...
              <span className="text-[10px] text-on-surface-variant font-normal">OFFICER-8842</span>
            </button>
          </div>
        </div>
