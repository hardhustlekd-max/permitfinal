...
export const Icon: React.FC<IconProps> = ({ name, className = '', size = 20, ...props }) => {
  // Clean clean up name if passed as expression or fallback
  ...
  switch (cleanName) {
    ...
    case 'sync':
      return (
        <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
          <path d="M21.5 2v6h-6M21.34 15.57a10 10 0 1 1-.57-8.38l5.73-5.73"></path>
        </svg>
      );
    case 'zoom_in':
      return (
